...
select employee_name, monthly_salary! from employees left join employees_salary 
on employees.id = employees_salary.employee_id where monthly_salary is NULL
